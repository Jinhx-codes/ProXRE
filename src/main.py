...
if __name__ == "__main__":
    ...
    parser.add_argument("--indomain_test_indices_file", type=str, default="/dataset/test_redocred_1_doc_indices.json",
                        help="indomain test indices file path")
    parser.add_argument("--scierc_test_indices_file", type=str, default="/dataset/test_scierc_1_doc_indices.json",
    ...
    parser.add_argument("--model_name_or_path", type=str, default="/data/huggingface/models/bert-base-cased",
    ...
    parser.add_argument("--lamda", type=float, default=0.85, help="weight of contrastive loss")
    ...
    parser.add_argument("--project", type=str, default="FSDLRE", help="project name")
    ...
    loss_agg = 0
    count = 0
    with range(int(args.samples_per_ep / args.train_batch_size)) as pbar:
        for _ in pbar:
            try:
    ...
    if args.test_domain == "indomain":
        ...
        true_positives, false_positives, false_negatives = {}, {}, {}
        for batch in indomain_test_loader:
            exemplar_tokens, exemplar_mask, exemplar_positions, exemplar_labels, query_tokens, query_mask, query_positions, query_labels, label_types = batch
            output = encoder(exemplar_tokens.to('cuda'),
                                exemplar_mask.to('cuda'),
                                exemplar_positions,
    ...
    if args.test_domain == "crossdomain":
        ...
        true_positives, false_positives, false_negatives = {}, {}, {}
        for batch in scierc_test_loader:
            exemplar_tokens, exemplar_mask, exemplar_positions, exemplar_labels, query_tokens, query_mask, query_positions, query_labels, label_types = batch
            output = encoder(exemplar_tokens.to('cuda'),
                                exemplar_mask.to('cuda'),
                                exemplar_positions,
